...
<p>This page shows the use of query parameters on the client side. In <code>App.svelte</code> you can find the following
    code</p>
<p>
    <code>
...
<p>
    The manual for <code>URLSearchParams</code> can be found <a
        href="https://developer.mozilla.org/en-US/docs/Web/API/URLSearchParams">here</a>.
</p>
